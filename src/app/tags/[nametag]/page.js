...
const decodedString = decodeURIComponent(params.nametag);

    return {
      title: `مطالبی درباره ${decodedString}`,
      description: `اگر به دنبال مطالبی در رابطه با ${decodedString} هستید ما این مطالب را برایتان به شکلی منظم در سایتمان قرار داده ایم.`,
      keywords:decodedString,
      author: "unicodewebdeisgn",
      openGraph: {
        title: `مطالبی درباره ${decodedString}`,
        description: `اگر به دنبال مطالبی در رابطه با ${decodedString} هستید ما این مطالب را برایتان به شکلی منظم در سایتمان قرار داده ایم.`,
       
        url: `https://unicodewebdesign.com/tags/${decodedString}`,
      },
      twitter: {
        title: `مطالبی درباره ${decodedString}`,
        description: `اگر به دنبال مطالبی در رابطه با ${decodedString} هستید ما این مطالب را برایتان به شکلی منظم در سایتمان قرار داده ایم.`,
...
const decodedString = decodeURIComponent(params.nametag);
    ...
    const keydata = dataposts.filter(item => item.keyword.includes(decodedString));
   ...
   <>
      ...
      <div class="max-w-[85rem] px-4 py-[20%] sm:px-6 lg:px-8 lg:py-[10%] mx-auto">
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          <h1 class="text-2xl font-bold md:text-4xl md:leading-tight">
       
          {decodedString}
          </h1>
          <p class="mt-1 text-gray-600">
            تمام پست های سایت با این تگ را میتوانید در اینجا مشاهده نمایید.
          </p>
        </div>
