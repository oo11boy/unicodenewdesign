...
const Uploader = dynamic(() => import('@/Components/Dashboard/Uploader/Uploader'), {
  ssr: false,
})
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li onClick={() => handleStatusChange("addpost")}>
              <a 
                href="#" 
            ...
            <li onClick={() => handleStatusChange("posts")}> 
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">پست ها</span>
              </a>
            </li>
            <li onClick={() => handleStatusChange("uploader")}>
              <a 
                href="#" 
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
