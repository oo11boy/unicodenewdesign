    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="py-14 flex flex-col lg:flex-row justify-between gap-8 border-b border-gray-500">
        <div class="w-full max-lg:mx-auto flex flex-col sm:flex-row max-lg:items-center max-lg:justify-between gap-6 md:gap-12 lg:gap-24">
          <div class="">
            <h6 class="text-lg font-medium text-white mb-7 max-lg:text-center">پیوندهای اصلی</h6>
            <ul class="flex flex-col max-lg:items-center gap-6">
              <li><a href="../"
                  class="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">صفحه اصلی</a>
              </li>
              <li><a href="../blog"
                  class="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">وبلاگ</a>
              </li>
              <li><a href="../"
                  class="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">طراحی سایت</a>
              </li>
             
            </ul>
          </div>
          <div class="">
            <h6 class="text-lg font-medium text-white mb-7 max-lg:text-center">دسته بندی</h6>
            <ul class="flex flex-col gap-6 max-lg:items-center">
              <li><a href="javascript:;"
                  class="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">طراحی سایت فروشگاهی ارزان
                  </a></li>
              <li><a href="javascript:;"
                  class="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">طراحی سایت شرکتی ارزان
                 </a></li>
              <li><a href="javascript:;"
                  class="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">طراحی سایت اقتصادی ارزان
                 </a></li>
        ...
        <div class="w-full lg:max-w-md max-lg:mx-auto ">
          ...
          <div class="bg-white rounded-3xl flex items-center justify-center p-5">
            <a href={'https://trustseal.enamad.ir/?id=467521&Code=8RJb5Bl8uzBsckWVX7RfaZnom53ODxSQ'}>
        <Image alt="نماد اعتماد یونیکد" title="نماد اعتماد یونیکد" src={'https://www.paydarweb.net/uploads/pages/1d2ab0.png'} width={150} height={100} />
        </a>
          </div>
        </div>
      </div>
      <div class="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
        ...
        <a href="https://pagedone.io/" class="">©</a>تمامی حقوق محفوظ است.
        </span>
