    ...
    <div class="pt-5 bg-gray-900" id="pricing">
      <div class="mx-auto pb-20 mt-4 max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-4xl text-center">
          ...
          <h3 class="mt-2 text-4xl font-bold tracking-tight text-white sm:text-5xl">
            تعرفه سفارش طراحی سایت
          </h3>
        </div>
        ...
        <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <div class="ring-1 ring-white/50 rounded-3xl p-8 xl:p-10">
            ...
            <p class="mt-4 text-sm leading-6 text-gray-300">
              مناسب سایت های شخصی و رزومه ای و کوچک
            </p>
            ...
            >
              جزییات بیشتر خرید سایت اقتصادی
            </Link>
            <ul
              role="list"
          ...
          <div class="bg-white/5 ring-2 ring-indigo-500 rounded-3xl p-8 xl:p-10">
            ...
            <p class="mt-6 flex items-baseline gap-x-1">
              <span class="text-4xl font-bold tracking-tight text-white">
                شروع از 6 میلیون تومان
              </span>
              <span class="text-sm font-semibold leading-6 text-gray-300"></span>
            </p>
            <Link
              href="../store_design"
              aria-label="طراحی سایت فروشگاهی"
            ...
            >
              جزییات بیشتر خرید سایت فروشگاهی
            </Link>
            <ul
              role="list"
              class="mt-8 space-y-3 text-sm leading-6 text-gray-300 xl:mt-10"
            >
              ...
              <li class="flex gap-x-3">
                ...
                تمام امکانات سایت های معروف فروشگاهی مانند دیجیکالا
              </li>
              <li class="flex gap-x-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                ریسپانسیو و مناسب نمایشگر های مختلف
              </li>
            </ul>
          </div>
          ...
          <div class="ring-1 ring-white/50 rounded-3xl p-8 xl:p-10">
            ...
            <p class="mt-4 text-sm leading-6 text-gray-300">
              مناسب برای انواع شرکت های مختلف
            </p>
            <p class="mt-6 flex items-baseline gap-x-1">
              <span class="text-4xl font-bold tracking-tight text-white">
                شروع از 4 میلیون تومان
              </span>
              <span class="text-sm font-semibold leading-6 text-gray-300"></span>
            </p>
            <Link
              href="../company_design"
              aria-label="طراحی سایت شرکتی"
              class="bg-white/10 text-white hover:bg-white/20 focus-visible:outline-white mt-6 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
            >
              جزییات بیشتر خرید سایت شرکتی
            </Link>
            <ul
              role="list"
              class="mt-8 space-y-3 text-sm leading-6 text-gray-300 xl:mt-10"
            >
              ...
              <li class="flex gap-x-3">
                ...
                ریسپانسیو شده و مناسب نمایشگر های مختلف
              </li>
            </ul>
          </div>
        </div>
